  ...
  $link_url = $_POST['base_url'];
   ...
   if(!empty($nome) && !empty($email_cliente) && !empty($telefone) && !empty($msg) ){
      ...
      try {
        ...
        $mail->Host       = 'smtp.kinghost.net';                     //Set the SMTP server to send through smtp.kinghost.net
        $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
        $mail->Username   = 'relacionamiento@fatcred.com.br';                     //SMTP username
        ...
        //Recipients
        $mail->setFrom('relacionamiento@fatcred.com.br', 'Contato - Fatcred');
        $mail->addAddress('relacionamiento@fatcred.com.br', 'Formulário do site');     //Add a recipient
