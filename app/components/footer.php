    <footer>
      <div class="container  pt-5 pb-3 mobile-texto-centro">
        <div class="row">
          ...
          <div class="col-12 col-ms-12 col-lg-4 mb-4">
            <h5 class="laranja mb-2">ENDEREÇOS</h5>
            <p class = "mb-1">
              <strong class = "laranja">
                Matriz - Fátima do Sul-MS
              </strong><br />
              <span>Avenida 09 de Julho, 30.</span>
            </p>
            <p class = "mb-1">
              <strong class = "">
            ...
            <p class = "mb-1">
              ...
              <span>Rua Fanoel do Ouro, 597.</span>
            </p>
            <p class = "mb-1">
              <strong class = "">
                Ivinhema - MS
            ...
            <p class = "mb-1">
              ...
              <span>Rua Pereira do Lago, 2520.</span>
            </p>
          </div>

          <div class="col-12 col-ms-12 col-lg-4">
        ...
        <div class="row mt-5 mb-3 dev centro">
          <div class="col-12 col-ms-12 col-lg-12 f-12">
            <img src="<?= BASE_IMG ?>marcas/logo_w1.png" class = "img-fluid">
          </div>
        </div>
      </div>
    </footer>